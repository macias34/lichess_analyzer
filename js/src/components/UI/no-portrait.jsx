...
const NoPortrait = () => {
  return (
    <div className="hidden max-[550px]:flex absolute gap-5 text-lg top-1/2 left-1/2 flex-col w-full items-center justify-center -translate-y-1/2 -translate-x-1/2">
